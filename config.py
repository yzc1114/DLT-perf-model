...
train_configs = {
    ModelType.MLP: {
        "model": "MLP",
        "all_seed": 42,
        "dataset_environment_str": "TEST_CPU80",
        ...
        "meta_configs": {
            ...
            "meta_fast_adaption_step": 5,
            "meta_dataset_train_environment_strs": ["TEST_CPU80"],
            "meta_dataset_eval_environment_strs": ["TEST_CPU80"],
    ...
    ModelType.PerfNet: {
        "model": "PerfNet",
        "dataset_environment_str": "TEST_CPU80",
        "meta_dataset_environment_strs": ["TEST_CPU80"],
        "dataset_normalization": "Standard",
        "all_seed": 42,
        "dataset_params": {
            "duration_summed": False,
